...
![@Structure of This Course](../screenshots/2017-10-17_1502668708572.png)
...
- ![Data Structure](../screenshots/2017-10-17_1502724390739.png)

- ![Types of Features](../screenshots/2017-10-17_1502724434736.png)
...
- Loading data
	- **pd.read_csv** and **pd.read_html**
		...
		- ![Axis Setting](../screenshots/2017-10-17_1502724512428.png)
...
- Dicing
	...
	- Replacing with Boolean
		- **df[df.recency < 7] = -100**
		- ![Example of Replacing with Boolean](../screenshots/2017-10-17_1502721957958.png)
...
![@G3](../screenshots/2017-10-17_1503928707234.png) ![@G1+G2+G3](../screenshots/2017-10-17_1503928710002.png)
...
![Parallel Coordinates](../screenshots/2017-10-17_1503932447227.png)
...
![@Andrew's Curve in Python](../screenshots/2017-10-17_1503932214245.png)![@Andrew's Curve in Matlab Plotting Mean and Cut-off](../screenshots/2017-10-17_1503932246680.png)
...
![Matrix Plot by Imshow](../screenshots/2017-10-17_1503932895621.png)
...
![@Best View](../screenshots/2017-10-17_1504020663963.png)![@Top View - less effective](../screenshots/2017-10-17_1504020683800.png)![@Post Transforming](../screenshots/2017-10-17_1504020702868.png)
...
![@How PCA Works](../screenshots/2017-10-17_1504020951651.png)
...
def drawVectors(transformed_features, components_, columns, plt, scaled):
    ...
    return ax
```
![Output of Projecting Code](../screenshots/2017-10-17_1504021527949.png)
...
- Essentially a node distance map that has been fed into a special type of PCA -- *the direction with greatest distance variance is the one has most important information*
	...
	- ![Alt text](../screenshots/2017-10-17_1506216538106.png)
...
- **Procedure:**
	...
	- ![Alt text](../screenshots/2017-10-17_1506382982459.png)
...
```
![Alt text](../screenshots/2017-10-17_1506383981004.png)
...
- **Procedure:**
	...
	- ![@Comparison between linear correlation (y~x and x~y) and PCA](../screenshots/2017-10-17_1506427993194.png)
...
- Purify the decision by asking one YES/NO question per time
	...
	- ![Example of Decision Tree](../screenshots/2017-10-17_1503068527741.png)
...
- The Confusion Matrix
	...
	- ![Confusion Matrix](../screenshots/2017-10-17_1503497640055.png)
	- ![imshow of Confusion Matrix](../screenshots/2017-10-17_1503497654640.png)
